                                        ...
                                        <table class="w-full my-0 align-middle text-dark border-neutral-200">
                                            <thead class="align-bottom">
                                                <tr class="font-semibold text-[0.95rem] text-secondary-dark">
                                                    ...
                                                    <th class="pb-3 text-center min-w-[50px]">NÚMERO DE CEDULA</th>
                                                    <th class="pb-3 text-center min-w-[100px]">NOMBRE</th>
                                                    <th class="pb-3 text-center min-w-[150px]">EMAIL</th>
                                                    <th class="pb-3 text-center min-w-[50px]">FECHA CREACIÓN</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-b border-dashed last:border-b-0">
                                                    <td class="p-3 pl-0">
                                                        <div class="flex items-center">
                                                            <div class="flex flex-col justify-start">
                                                                <span
                                                                class="font-semibold text-light-inverse text-md/normal">{{str_pad($cliente->id, 4, 0, STR_PAD_LEFT)}}
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="p-3 pr-0 text-center">
                                                        <span
                                                            class="font-semibold text-light-inverse text-md/normal">{{$cliente->numero_identidad}}
                                                        </span>
                                                    </td>
                                                    <td class="p-3 pr-0 text-center">
                                                        <span
                                                            class="font-semibold text-light-inverse text-md/normal">{{$cliente->nombre}}
                                                        </span>
                                                    </td>
                                                    <td class="p-3 pr-0 text-center">
                                                        <span
                                                            class="font-semibold text-light-inverse text-md/normal">{{$cliente->email}}
                                                        </span>
                                                    </td>
                                                    <td class="p-3 pr-0 text-center">
                                                        <span
                                                            class="font-semibold text-light-inverse text-md/normal">{{$cliente->created_at}}
                                                        </span>
                                                    </td>
                                                    <td class="p-3 pr-0 text-center">
                                                        ...
                                                        <a href="{{ route('clientes.edit', ['cliente' => $cliente->id]) }}" class="text-yellow-400 hover:text-gray-100 mx-2">
